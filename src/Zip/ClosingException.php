...
/**
 * This is the closing exception class.
 *
 * @author    Graham Campbell <graham@mineuk.com>
 * @copyright 2014 Graham Campbell
 * @license   <https://github.com/GrahamCampbell/Laravel-Fixer/blob/master/LICENSE.md> Apache 2.0
 */
class ClosingException extends ArchiveException
{
    /**
     * Create a closing exception instance.
     *
     * @param string      $path
    ...
    {
        if (!$message) {
            $message = "The archive located at '$path' could not be closed.";
        }
