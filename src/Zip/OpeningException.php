...
/**
 * This is the opening exception class.
 *
 * @author    Graham Campbell <graham@mineuk.com>
 * @copyright 2014 Graham Campbell
 * @license   <https://github.com/GrahamCampbell/Laravel-Fixer/blob/master/LICENSE.md> Apache 2.0
 */
class OpeningException extends ArchiveException
{
    /**
     * Create a opening exception instance.
     *
     * @param string      $path
    ...
    {
        if (!$message) {
            $message = "The archive located at '$path' could not be opened.";
        }
